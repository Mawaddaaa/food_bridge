...
import 'package:food_bridge/controller/receiver/receiver_home_screen_controller.dart';
...
class ReceiverDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ReceiverHomeScreenControllerImp controller = Get.put(ReceiverHomeScreenControllerImp());
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  drawerItem(Icons.shopping_bag, "DrawerReservations".tr, () {
                    controller.changePageFromDrawer(1);
                  }),
                  drawerItem(Icons.card_travel, "DrawerOrders".tr, () {
                    Get.toNamed(AppRoute.pendingorders);
                  }),
                  drawerItem(Icons.archive, "DrawerArchive".tr, () {
